        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu ">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="javascript:;">Cards</a></li>
                        <li class="sub-slide">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="sub-slide">
                            <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span class="sub-side-menu__label">Receive
                            </span><i class="sub-angle fe fe-chevron-down"></i></a>
                            <ul class="sub-slide-menu">
                                <li class="sub-slide2">
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="{{ route('user.receive.create') }}">Receive
                                    </a>
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="javascript:;" onclick="comingSoon();">Money Receipt</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-slide">
                            <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span class="sub-side-menu__label">Expense
                            </span><i class="sub-angle fe fe-chevron-down"></i></a>
                            <ul class="sub-slide-menu">
                                <li class="sub-slide2">
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="{{ route('user.expense.create') }}">Expense
                                    </a>
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="javascript:;" onclick="comingSoon();">Supplier Payment</a>
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="javascript:;" onclick="comingSoon();">Cllient Loan</a>
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="javascript:;" onclick="comingSoon();">Client Money Return</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-slide">
                            <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span class="sub-side-menu__label">Account</span><i class="sub-angle fe fe-chevron-down"></i></a>
                            <ul class="sub-slide-menu">
                                <li class="sub-slide2">
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="{{ route('user.account.create') }}">Add New Account</a>
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="javascript:;" onclick="comingSoon();">Account List</a>
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="javascript:;" onclick="comingSoon();">Account Balance</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="sub-slide">
                            <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span class="sub-side-menu__label">Client</span><i class="sub-angle fe fe-chevron-down"></i></a>
                            <ul class="sub-slide-menu">
                                <li class="sub-slide2">
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="{{ route('user.client.create') }}">Add New Client</a>
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="javascript:;" onclick="comingSoon();">Client List</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sub-slide">
                            <a class="slide-item" data-bs-toggle="sub-slide" href="javascript:void(0);"><span class="sub-side-menu__label">Supplier</span><i class="sub-angle fe fe-chevron-down"></i></a>
                            <ul class="sub-slide-menu">
                                <li class="sub-slide2">
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="{{ route('user.supplier.create') }}">Add New Supplier</a>
                                    <a class="sub-side-menu__item" data-bs-toggle="sub-slide2" href="javascript:;" onclick="comingSoon();">Supplier List</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
