                ...
                <div class="main-header-right">
                    ...
                    <div class="nav nav-item  navbar-nav-right mg-lg-s-auto">
                        ...
                        <div class="dropdown main-profile-menu nav nav-item nav-link">
                            <a class="profile-user d-flex" href=""><img src="{{ asset('dashboard/img/avatar5.png') }}" alt="user-img" class="rounded-circle mCS_img_loaded bg-white"><span></span></a>

                            <div class="dropdown-menu">
                                <div class="main-header-profile header-img">
                                    <div class="main-img-user border bg-white"><img alt="" src="{{ asset('dashboard/img/avatar5.png') }}"></div>
                                    <h6>{{ Auth::user()->name }}</h6><span>{{ Auth::user()->username }}</span>
                                </div>
                                <a class="dropdown-item" href="javascript:;" onclick="comingSoon();"><i class="far fa-user"></i> My Profile</a>
                                <a class="dropdown-item" href="javascript:;" onclick="comingSoon();"><i class="far fa-edit"></i> Edit Profile</a>
                                <a class="dropdown-item" href="javascript:;" onclick="comingSoon();"><i class="far fa-clock"></i> Activity Logs</a>
                                <a class="dropdown-item" href="javascript:;" onclick="comingSoon();"><i class="fas fa-sliders-h"></i> Account Settings</a>
