                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-4 col-lg-4 col-md-4">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <input type="text" value="{{ $exam->title_en ?? old('title_en') }}"
                                        class="form-control" name="title_en" placeholder="Exam Title English">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xl-4 col-lg-4 col-md-4">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <span class="input-group-text" id="basic-addon1"><i class="fas fa-tags"></i></span>
                                    <input type="text" value="{{ $exam->title_bn ?? old('title_bn') }}"
                                        class="form-control" name="title_bn" placeholder="Exam Title Bangla">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xl-4 col-lg-4 col-md-4">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    title="Exam Topics">
                                    <span class="input-group-text" id="basic-addon1"><i class="fas fa-tags"></i></span>
                                    <input type="text" value="{{ $exam->class_topic ?? old('class_topic') }}"
                                        class="form-control" name="class_topic" placeholder="Exam Topics">
                                </div>
                            </div>
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="datetime-local" name="start_time" id="start_time" class="form-control"
                                        value="{{ $exam->start_time ? $exam->start_time->format('Y-m-d\TH:i') : old('start_time') }}"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="datetime-local" name="end_time" id="end_time" class="form-control"
                                        value="{{ $exam->end_time ? $exam->end_time->format('Y-m-d\TH:i') : old('end_time') }}"
                                        required>
                                </div>
                            </div>
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <input type="text" value="{{ $exam->code }}" class=" form-control"
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <span class="input-group-text" title="Exam Total Marks" id="basic-addon1"><i
                                            class="fas fa-building"></i></span>
                                    <input type="number" min="0" value="{{ $exam->total_mark }}"
                            ...
                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                                <button type="submit" class="add-to-cart btn btn-success btn-block"><i
                                        class="fas fa-plus"></i> Update Exam</button>
                            </div>
                        </div>
                    </form>
                </div>
