            ...
            <form action="{{ route('admin.exam.update',$exam->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       ...
                       @error('title_en') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Exam Title English">
                            ...
                            <input type="text" value="{{ $exam->title_en }}" class=" form-control" name="title_en" placeholder="Exam Title English">
                        </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('title_bn') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Exam Title Bangla">
                             <span class="input-group-text" id="basic-addon1"><i class="fas fa-tags"></i></span>
                             <input type="text" value="{{ $exam->title_bn }}" class=" form-control" name="title_bn" placeholder="Exam Title Bangla">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('code') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Exam Code">
                             ...
                             <input type="text" value="{{ $exam->code }}" class=" form-control" name="code" placeholder="Exam Code">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-63">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="typcn typcn-calendar-outline tx-24 lh--9 op-6"></i></span>
                            <input name="time" id="time" class="form-control" placeholder="Exam Time" value="{{ $exam->time }}" type="time" autocomplete="off" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Exam Time">
                        </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('marks') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Exam Total Marks">
                             ...
                             <input type="number" min="0" value="{{ $exam->marks }}" class=" form-control" name="marks" placeholder="Exam Total Marks">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('totaltime') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Exam Total Time">
                             ...
                             <input type="number" min="0" value="{{ $exam->totaltime }}" class=" form-control" name="totaltime" placeholder="Exam Total Time">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                            ...
                            <select name="class_id" class="select2 form-control">
                                ...
                                @foreach($classes as $class)
                                    ...
                                    @foreach($question_class->unique('class_id') as $key => $question)
                                        <option value="{{ $question->class_id }}" @if($question->class_id == $class->id) selected @endif>
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i> Update Exam</button>
                    </div>
                </div>
            </form>
        </div>
