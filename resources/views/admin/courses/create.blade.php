                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <input type="text" value="{{ old('title_en') }}" class=" form-control"
                                        name="title_en" placeholder="Course Title English">
                                </div>
                            </div>
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                @enderror
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    title="Course Title Bangla">
                                    <span class="input-group-text" id="basic-addon1"><i class="fas fa-tags"></i></span>
                                    <input type="text" value="{{ old('title_bn') }}" class=" form-control"
                                        name="title_bn" placeholder="Course Title Bangla">
                                </div>
                            </div>
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <input type="text" value="{{ old('level') }}" class=" form-control"
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <input type="text" value="{{ old('lessons') }}" class=" form-control"
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <span class="input-group-text" title="Course Duration" id="basic-addon1"><i
                                            class="fas fa-cog"></i></span>
                                    <input type="text" min="0" value="{{ old('duration') }}"
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <input type="text" min="0" value="{{ old('hours') }}"
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <span class="input-group-text" title="Course Resources" id="basic-addon1"><i
                                            class="fas fa-cog"></i></span>
                                    <input type="text" min="0" value="{{ old('resources') }}"
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <span class="input-group-text" title="Course Certificate" id="basic-addon1"><i
                                            class="fas fa-user"></i></span>
                                    <input type="text" min="0" value="{{ old('certificate') }}"
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <select name="featured" class="select2 form-control">
                                        ...
                                        <option value="1" {{ old('featured') == '1' ? 'selected' : '' }}>Is Featured
                                        </option>
                                        <option value="0" {{ old('featured') == '0' ? 'selected' : '' }}>Not Is
                                            Featured</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                @error('category_id')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <div class="" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    title="Category Name">
                                ...
                                <div class="wrap" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <select name="class_id" class="select2 form-control">
                                        ...
                                        @foreach ($classes as $class)
                                            @if ($class)
                                                @php
                                                    $question_class = App\Models\Question::where('class_id', $class->id)
                                                        ->latest()
                                                        ->get();
                                                @endphp

                                                @foreach ($question_class->unique('class_id') as $key => $question)
                                                    <option value="{{ $question->class_id }}">
                                                        {{ $question->class->name_en ?? 'Null' }}
                                                    </option>
                                                @endforeach
                                            @endif
                                        @endforeach
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="wrap" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <select name="type" class="select2 form-control">
                                        ...
                                        <option value="3">Others Course</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xl-3 col-lg-3 col-md-6">
                                ...
                                @enderror
                                <img id="showImage"
                                    src="{{ !empty($profile->image) ? url('upload/course/' . $profile->image) : url('upload/no_image.jpg') }}"
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <input type="text" min="0" value="{{ old('video_link') }}"
                            ...
                            <div class="form-group col-xl-4 col-lg-4 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <select name="discount_type" class=" form-control">
                                        ...
                                        <option value="2" {{ old('discount_type') == '0' ? 'selected' : '' }}>Parcent
                                            %</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xl-12 col-lg-12  col-md-6">
                                ...
                                <div class="text-wrap" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <textarea name="description_en" id="description_en" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                        title="Course Description English">{{ old('description_en') }}</textarea>
                                </div>
                            </div>
