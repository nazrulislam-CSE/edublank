                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       ...
                       @error('course_name') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group">
                            ...
                            <input type="text" value="" class=" form-control" name="course_name" placeholder="Course Name">
                        </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('course_title') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="" class=" form-control" name="course_title" placeholder="Course Title">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('course_level') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="" class=" form-control" name="course_level" placeholder="Course Level">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('course_lessons') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="" class=" form-control" name="course_lessons" placeholder="Course Lessons">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('course_duration') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" min="0" value="" class=" form-control" name="course_duration" placeholder="Course Duration">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('course_hours') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" min="0" value="" class=" form-control" name="course_hours" placeholder="Course Hourse">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('resources') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" min="0" value="" class=" form-control" name="resources" placeholder="Course Resources">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <select  name="featured" class=" form-control">
                             <option value="">Select Status</option>
                                ...
                                <option value="0">Not Is Featured</option>
                            </select>
                        </div>
                    </div>
