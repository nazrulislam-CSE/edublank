              ...
              <div class="row">
                    <div class="form-group col-xl-12 col-lg-12 col-md-6">
                        ...
                        <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Name English">
                            <span class="input-group-text" title="Subject Name English" id="basic-addon1"><i class="fas fa-tags"></i></span>
                            <input type="text" value="{{ $subject->name_en }}" class=" form-control" name="name_en" placeholder="Subject Name English">
                        </div>
                    </div>
                    <div class="form-group col-xl-12 col-lg-12 col-md-6">
                        ...
                        <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Name Bangla">
                            ...
                            <input type="text" value="{{ $subject->name_bn }}" class=" form-control" name="name_bn" placeholder="Subject Name Bangla">
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i> Update Subject</button>
                    </div>
                </div>
            </form>
        </div>
