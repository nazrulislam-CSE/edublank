                    ...
                    <div class="form-group col-xl-12 col-lg-12 col-md-6">
                       ...
                       @error('name_en') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Name English">
                            ...
                            <input type="text" value="" class=" form-control" name="name_en" placeholder="Subject Name English">
                        </div>
                    </div>
                    <div class="form-group col-xl-12 col-lg-12 col-md-6">
                        ...
                        @error('name_bn') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group"  data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Name Bangla">
                             ...
                             <input type="text" value="" class=" form-control" name="name_bn" placeholder="Subject Name Bangla">
                         </div>
                    </div>
