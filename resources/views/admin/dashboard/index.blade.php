                ...
                <a href="javascript:;" class="text-dark" onclick="comingSoon();">
                    <div class="card overflow-hidden project-card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="my-auto">
                                    <img src="{{ asset('dashboard/img/icons/daily-sale.png') }}" alt="" class="me-5 ht-70 wd-70 my-auto border shadow-sm rounded-lg p-2 bg-light">
                                </div>
                                <div class="project-content d-grid align-items-center">
                                    <h4>{{ __('Total Certifications') }}</h4>
                                    <ul>
                                        <li>
                                            <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                            <span><strong style="font-size: 15px !important;">10,000,0000</strong></span>
                ...
                <a href="javascript:;" class="text-dark" onclick="comingSoon();">
                    <div class="card overflow-hidden project-card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="my-auto">
                                    <img src="{{ asset('dashboard/img/icons/daily-deposit.png') }}" alt="" class="me-5 ht-70 wd-70 my-auto border shadow-sm rounded-lg p-2 bg-light">
                                </div>
                                <div class="project-content d-grid align-items-center">
                ...
                <a href="javascript:;" class="text-dark" onclick="comingSoon();">
                    <div class="card overflow-hidden project-card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="my-auto">
                                    <img src="{{ asset('dashboard/img/icons/daily-expense.png') }}" alt="" class="me-5 ht-70 wd-70 my-auto border shadow-sm rounded-lg p-2 bg-light">
                                </div>
                                <div class="project-content d-grid align-items-center">
                                    <h4>{{ __('Total Paid Course') }}</h4>
                                    <ul>
                                        <li>
                                            <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                            <span><strong style="font-size: 15px !important;">10,000,0000</strong></span>
                ...
                <a href="javascript:;" class="text-dark" onclick="comingSoon();">
                    <div class="card overflow-hidden project-card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div class="my-auto">
                                    <img src="{{ asset('dashboard/img/icons/scale.png') }}" alt="" class="me-5 ht-70 wd-70 my-auto border shadow-sm rounded-lg p-2 bg-light">
                                </div>
                                <div class="project-content d-grid align-items-center">
                                    <h4>{{ __('Total UnPaid Course') }}</h4>
                                    <ul>
                                        <li>
                                            <strong class="d-inline-flex mb-0" style="font-size: 15px !important;">Total:</strong>
                                            <span><strong style="font-size: 15px !important;">10,000,0000</strong></span>
