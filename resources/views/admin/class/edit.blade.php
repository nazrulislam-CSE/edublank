                    ...
                    <form action="{{ route('admin.class.update', $class->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="form-group col-xl-12 col-lg-12 col-md-12">
                                ...
                                @enderror
                                <select name="batch_id" class="select2 form-control" data-bs-placement="top"
                                    data-bs-toggle="tooltip-primary" title="Batch Name">
                                    <option value="">Select Batch</option>
                                    @foreach ($batches as $batch)
                                        <option
                                            value="{{ $batch->id }}"@if ($batch->id == $class->batch_id) selected @endif>
                                            {{ $batch->name_en }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <input type="text" value="{{ $class->name_en ?? 'Null' }}" class=" form-control"
                                        name="name_en" placeholder="Class Name English">
                                </div>
                            </div>
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <span class="input-group-text" title="Subject Name Bangla" id="basic-addon1"><i
                                            class="fas fa-tags"></i></span>
                                    <input type="text" value="{{ $class->name_bn ?? 'Null' }}" class=" form-control"
                                        name="name_bn" placeholder="Class Name Bangla">
                                </div>
                            </div>
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <span class="input-group-text" title="Class Name Bangla" id="basic-addon1"><i
                                            class="fas fa-tags"></i></span>
                                    <input type="text" value="{{ $class->video ?? 'Null' }}" class=" form-control"
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    ...
                                    <span class="input-group-text" title="Class Name Bangla" id="basic-addon1"><i
                                            class="fas fa-tags"></i></span>
                                    <input type="text" value="{{ $class->listening_voice ?? 'Null' }}"
                                        class=" form-control" name="listening_voice"
                                        placeholder="Class Listening Voice Link">
                                </div>
                            </div>
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                @error('subject_id')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <select name="subject_id" class="select2 form-control" data-bs-placement="top"
                                    data-bs-toggle="tooltip-primary" title="Subject Name">
                                    <option value="">Select Subject</option>
                                    @foreach ($subjects as $subject)
                                        <option
                                            value="{{ $subject->id }}"@if ($subject->id == $class->subject_id) selected @endif>
                                            {{ $subject->name_en }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="1" @if ($class->status == 1) selected @endif>Active
                                        </option>
                                        <option value="0" @if ($class->status == 0) selected @endif>Deactive
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-xl-6 col-lg-6 col-md-6">
                                ...
                                <iframe src="{{ $class->lecture_shit }}" frameborder="0" width="100"
                                    height="20"></iframe>
                            </div>
                            ...
                            <div class="form-group col-xl-12 col-lg-12  col-md-6">
                                ...
                                <textarea name="description_en" id="description_en" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    title="Description English">{{ $class->description_en ?? 'Null' }}</textarea>
                            </div>
                            ...
                            <div class="form-group col-xl-12 col-lg-12  col-md-6">
                                ...
                                <textarea name="description_bn" id="description_bn" data-bs-placement="top" data-bs-toggle="tooltip-primary"
                                    title="Description Bangla">{{ $class->description_bn ?? 'Null' }}</textarea>
                            </div>

                            <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                                <button type="submit" class="add-to-cart btn btn-success btn-block"><i
                                        class="fas fa-plus"></i> Update Class</button>
                            </div>
                        </div>
                    </form>
                </div>
