            ...
            <form action="{{ route('admin.class.store')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       ...
                       @error('name_en') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Class Name Englilsh">
                            ...
                            <input type="text" value="{{ old('name_en')}}" class=" form-control" name="name_en" placeholder="Class Name English">
                        </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('name_bn') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Class Name Bangla">
                             ...
                             <input type="text" value="{{ old('name_bn')}}" class=" form-control" name="name_bn" placeholder="Class Name Bangla">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('video') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Class Video Link">
                             ...
                             <input type="text" value="{{ old('video')}}" class=" form-control" name="video" placeholder="Class Video Link">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('listening_voice') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Class Listening Voice">
                             <span class="input-group-text" title="Class Name Bangla" id="basic-addon1"><i class="fas fa-tags"></i></span>
                             <input type="text" value="{{ old('listening_voice')}}" class=" form-control" name="listening_voice" placeholder="Class Listening Voice Link">
                         </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="form-group col-xl-12 col-lg-12  col-md-6">
                        ...
                        <div class="text-wrap" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Description English">
                            <textarea name="description_en" id="description_en" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Description English">{{ old('description_en')}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-12 col-lg-12  col-md-6">
                        ...
                        <div class="text-wrap" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Description Bangla">
                            <textarea name="description_bn" id="description_bn" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Description Bangla">{{ old('description_bn')}}</textarea>
                        </div>
                    </div>
  
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i> Add Class</button>
                    </div>
                </div>
            </form>
        </div>
