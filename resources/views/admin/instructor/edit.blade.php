            ...
            <form action="{{ route('admin.instructor.update',$instructor->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                        ...
                        <div class="input-group" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Status">
                            ...
                            <select  name="status" class=" form-control">
                             <option value="">Select Status</option>
                                <option value="1"@if($instructor->status == 1 ) selected @endif>Active</option>
                                <option value="0" @if($instructor->status == 0 ) selected @endif>Deactive</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        <img id="showImage" src="{{ (!empty($instructor->image)) ? url('upload/instructor/'.$instructor->image):url('upload/no_image.jpg') }}" alt="Admin" style="width:100px; height: 100px;"  >
                    </div>
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i> Update Instructor</button>
                    </div>
                </div>
            </form>
        </div>
