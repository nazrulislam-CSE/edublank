            ...
            <form action="{{ route('admin.section.update',$section->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                    <div class="form-group col-xl-12 col-lg-12 col-md-6">
                       ...
                       @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $section->name }}" class=" form-control" name="name" placeholder="Section Name">
                        </div>
                    </div>
                    <div class="form-group col-xl-12 col-lg-12 col-md-6">
                        ...
                        @error('title') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ $section->title }}" class=" form-control" name="title" placeholder="Section Title">
                         </div>
                     </div>
                    ...
                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 mt-3">
                        <button type="submit" class="add-to-cart btn btn-success btn-block"><i class="fas fa-plus"></i> Update Section</button>
                    </div>
                </div>
            </form>
        </div>
