                        ...
                        <div class="card card-danger card-outline shadow-lg">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <label for="business_address" class="col-form-label" style="font-weight: bold;">About</label>
                                        <input type="hidden" name="types[]" value="business_address">
                                        <textarea class="form-control" id="business_address" cols="2" name="business_address" placeholder="Write address here">{{ get_setting('business_address')->value ?? 'null'}}</textarea>
                                        @error('business_address')
                                            <p class="text-danger">{{$message}}</p>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="mb-2">
                                            <label for="site_favicon" class="col-form-label" style="font-weight: bold;">Site Favicon <span class="text-danger">(Size:16,16):</span></label>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="mb-2">
                                            <label for="image" class="col-form-label" style="font-weight: bold;">Site Logo <span class="text-danger">(Size:193,45):</span></label>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="mb-2">
                                            <label for="site_footer_logo" class="col-form-label" style="font-weight: bold;">Site Footer Logo <span class="text-danger">(Size:193,45):</label>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="mb-2">
                                            <label for="site_contact_logo" class="col-form-label" style="font-weight: bold;">Site Contact Logo <span class="text-danger">(Size:308,314):</label>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        <div class="mb-2">
                                            <img id="showCompany" class="rounded avatar-lg" src="{{ asset(get_setting('site_company_logo')->value ?? 'Null') }}" alt="No Image" width="696" height="">
                                        </div>
                                        <div class="mb-2">
                                            <label for="site_company_logo" class="col-form-label" style="font-weight: bold;">Company Banner <span class="text-danger">(Size:696,90):</label>
