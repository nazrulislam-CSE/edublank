              ...
              <div class="row">
                    <div class="form-group col-xl-12 col-lg-12 col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $question->question }}" class=" form-control" name="question" placeholder="Your question Name">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                       ...
                       @error('a') <span class="text-danger">{{ $message }}</span> @enderror
                        <div class="input-group">
                            ...
                            <input type="text" value="{{ $question->a }}" class=" form-control" name="a" placeholder="Option A">
                        </div>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('b') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ $question->b }}" class=" form-control" name="b" placeholder="Option B">
                         </div>
                     </div>
                     <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('c') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ $question->c }}" class=" form-control" name="c" placeholder="Option C">
                         </div>
                     </div>
                     <div class="form-group col-xl-6 col-lg-6 col-md-6">
                        ...
                        @error('d') <span class="text-danger">{{ $message }}</span> @enderror
                         <div class="input-group">
                             ...
                             <input type="text" value="{{ $question->d }}" class=" form-control" name="d" placeholder="Option D">
                         </div>
                    </div>
