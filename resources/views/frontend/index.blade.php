@extends('layouts.frontend.app', ['pageTitle' => 'Frontend Application'])
@section('content')
    @php
        $courses = App\Models\Course::where('status', 1)->latest()->get();
    @endphp
    <!--=====================================-->
                ...
                <div class="col-lg-6">
                    <div class="banner-content">
                        <h1 class="title" data-sal-delay="100" data-sal="slide-up" data-sal-duration="1000">Get <span
                                class="color-secondary">2500+</span> <br>Best Online Courses From EduBlink</h1>
                        ...
                        <ul class="shape-group">
                            <li class="shape-1 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="2" src="{{ asset('frontend/assets/images/about/shape-13.png') }}"
                                    alt="Shape">
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="banner-thumbnail">
                        ...
                        <ul class="shape-group">
                            <li class="shape-1" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="1.5" src="{{ asset('frontend/assets/images/about/shape-15.png') }}"
                                    alt="Shape">
                            </li>
                            <li class="shape-2 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="-1.5" src="{{ asset('frontend/assets/images/about/shape-16.png') }}"
                                    alt="Shape">
                            </li>
                            ...
                            <li class="shape-4" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="-1" src="{{ asset('frontend/assets/images/counterup/shape-02.png') }}"
                                    alt="Shape">
                            </li>
                            <li class="shape-5 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="1.5" src="{{ asset('frontend/assets/images/about/shape-13.png') }}"
                                    alt="Shape">
                            </li>
                            <li class="shape-6 scene" data-sal-delay="1000" data-sal="fade" data-sal-duration="1000">
                                <img data-depth="-2" src="{{ asset('frontend/assets/images/about/shape-18.png') }}"
                                    alt="Shape">
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="features-grid-wrap">
                <div class="features-box features-style-2 edublink-svg-animate">
                    <div class="icon">
                        <img class="svgInject"
                            src="{{ asset('frontend/assets/images/animated-svg-icons/online-class.svg') }}"
                            alt="animated icon">
                    </div>
                    <div class="content">
                ...
                <div class="features-box features-style-2 edublink-svg-animate">
                    <div class="icon">
                        <img class="svgInject"
                            src="{{ asset('frontend/assets/images/animated-svg-icons/instructor.svg') }}"
                            alt="animated icon">
                    </div>
                    <div class="content">
                ...
                <div class="features-box features-style-2 edublink-svg-animate">
                    <div class="icon certificate">
                        <img class="svgInject"
                            src="{{ asset('frontend/assets/images/animated-svg-icons/certificate.svg') }}"
                            alt="animated icon">
                    </div>
                    <div class="content">
            ...
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <div class="about-image-gallery">
                        <img class="main-img-1" src="{{ asset('frontend/assets/images/about/about-01.webp') }}"
                            alt="About Image">
                        <div class="video-box" data-sal-delay="150" data-sal="slide-down" data-sal-duration="800">
                            <div class="inner">
                                <div class="thumb">
                                    <img src="{{ asset('frontend/assets/images/about/about-02.webp') }}"
                                        alt="About Image">
                        ...
                        <ul class="shape-group">
                            <li class="shape-1 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                <img data-depth="1" src="{{ asset('frontend/assets/images/about/shape-36.png') }}"
                                    alt="Shape">
                            </li>
                            <li class="shape-2 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                <img data-depth="-1" src="{{ asset('frontend/assets/images/about/shape-37.png') }}"
                                    alt="Shape">
                            </li>
                            <li class="shape-3 scene" data-sal-delay="500" data-sal="fade" data-sal-duration="200">
                                <img data-depth="1" src="{{ asset('frontend/assets/images/about/shape-02.png') }}"
                                    alt="Shape">
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="edu-course course-style-1 hover-button-bg-white">
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="course-details.html">
                                        <img src="{{ asset('frontend/assets/images/course/course-07.jpg') }}"
                                            alt="Course Meta">
                                    </a>
                                    <div class="time-top">
                            ...
                            <div class="course-hover-content">
                                <div class="content">
                                    ...
                                    <span class="course-level">Advanced</span>
                                    <h6 class="title">
                                        <a href="course-details.html">{{ $course->title_en }}</a>
                                    </h6>
                                    <div class="course-rating">
                                        <div class="rating">
                                            <i class="icon-23"></i>
                                    ...
                                    <a href="course-details.html" class="edu-btn btn-secondary btn-small">Enrolled <i
                                            class="icon-4"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-8">
                    <div class="counterup-box-wrap">
                        ...
                        <ul class="shape-group">
                            ...
                            <li class="shape-2">
                                <img class="rotateit" src="{{ asset('frontend/assets/images/counterup/shape-02.png') }}"
                                    alt="Shape">
                            </li>
                            <li class="shape-3 scene">
                                <img data-depth="1.6" src="{{ asset('frontend/assets/images/counterup/shape-04.png') }}"
                                    alt="Shape">
                            </li>
                            <li class="shape-4 scene">
                                <img data-depth="-1.6" src="{{ asset('frontend/assets/images/counterup/shape-05.png') }}"
                                    alt="Shape">
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-grid">
                                    <div class="thumbnail">
                                        <img src="{{ asset('frontend/assets/images/testimonial/testimonial-01.png') }}"
                                            alt="Testimonial">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-grid">
                                    <div class="thumbnail">
                                        <img src="{{ asset('frontend/assets/images/testimonial/testimonial-02.png') }}"
                                            alt="Testimonial">
                                        <span class="qoute-icon"><i class="icon-26"></i></span>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-grid">
                                    <div class="thumbnail">
                                        <img src="{{ asset('frontend/assets/images/testimonial/testimonial-03.png') }}"
                                            alt="Testimonial">
                                        <span class="qoute-icon"><i class="icon-26"></i></span>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-grid">
                                    <div class="thumbnail">
                                        <img src="{{ asset('frontend/assets/images/testimonial/testimonial-04.png') }}"
                                            alt="Testimonial">
                                        <span class="qoute-icon"><i class="icon-26"></i></span>
                    ...
                    <div class="home-one-cta edu-cta-box bg-image">
                        ...
                        <ul class="shape-group">
                            <li class="shape-01 scene">
                                <img data-depth="2" src="{{ asset('frontend/assets/images/cta/shape-06.png') }}"
                                    alt="shape">
                            </li>
                            <li class="shape-02 scene">
                                <img data-depth="-2" src="{{ asset('frontend/assets/images/cta/shape-12.png') }}"
                                    alt="shape">
                            </li>
                            <li class="shape-03 scene">
                                <img data-depth="-3" src="{{ asset('frontend/assets/images/cta/shape-04.png') }}"
                                    alt="shape">
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="thumbnail-wrap">
                                <div class="thumbnail">
                                    <a href="team-details.html">
                                        <img src="{{ asset('frontend/assets/images/team/team-01.webp') }}"
                                            alt="team images">
                                    </a>
                                </div>
                    ...
                    <div class="edu-team-grid team-style-1">
                        <div class="inner">
                            <div class="thumbnail-wrap">
                                <div class="thumbnail">
                                    <a href="team-details.html">
                                        <img src="{{ asset('frontend/assets/images/team/team-02.webp') }}"
                                            alt="team images">
                                    </a>
                                </div>
                                <ul class="team-share-info">
                    ...
                    <div class="edu-team-grid team-style-1">
                        <div class="inner">
                            <div class="thumbnail-wrap">
                                <div class="thumbnail">
                                    <a href="team-details.html">
                                        <img src="{{ asset('frontend/assets/images/team/team-03.webp') }}"
                                            alt="team images">
                                    </a>
                                </div>
                                <ul class="team-share-info">
                    ...
                    <div class="edu-team-grid team-style-1">
                        <div class="inner">
                            <div class="thumbnail-wrap">
                                <div class="thumbnail">
                                    <a href="team-details.html">
                                        <img src="{{ asset('frontend/assets/images/team/team-04.webp') }}"
                                            alt="team images">
                                    </a>
                                </div>
                                <ul class="team-share-info">
    ...
    <div class="edu-cta-banner-area home-one-cta-wrapper bg-image">
        <div class="container">
            <div class="edu-cta-banner">
                ...
                <ul class="shape-group">
                    <li class="shape-01 scene">
                        <img data-depth="2.5" src="{{ asset('frontend/assets/images/cta/shape-10.png') }}"
                            alt="shape">
                    </li>
                    <li class="shape-02 scene">
                        <img data-depth="-2.5" src="{{ asset('frontend/assets/images/cta/shape-09.png') }}"
                            alt="shape">
                    </li>
                    <li class="shape-03 scene">
                        <img data-depth="-2" src="{{ asset('frontend/assets/images/cta/shape-08.png') }}"
                            alt="shape">
                    </li>
    ...
    <div class="edu-blog-area blog-area-1 edu-section-gap">
        ...
        <ul class="shape-group">
            ...
            <li class="shape-3 scene">
                <img data-depth="-2.3" src="{{ asset('frontend/assets/images/counterup/shape-05.png') }}"
                    alt="Shape">
            </li>
        </ul>
    </div>
